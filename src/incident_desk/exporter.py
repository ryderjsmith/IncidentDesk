...
class Exporter:
    ...
    def export_pdf(self, rows: List[sqlite3.Row], path: Path, parent=None, title: str = "Incident Board"):
        ...
        headers = ["Reported", "Dispatched", "Arrived", "Cleared", "Type", "Location", "Car #", "Driver Code", "Ambulance", "Unit", "Status", "Notes", "Billables"]
        ...
        for r in rows:
            ...
            data.append([
                ...
                P(r["type"]), P(r["location_name"] or ""), P(r["car_number"] or ""), P(r["driver_code"] or ""), P(r["ambulance"] or ""), P(r["primary_units"] or ""),
        ...
        col_widths = [60, 56, 56, 56, 48, 62, 36, 52, 50, 48, 36, 80, 80]  # sum = 720
